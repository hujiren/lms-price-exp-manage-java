...
public class ExpListController {
    ...
    public ResultUtil<Boolean> update(@NotNull(message = "id不能为空") @Validated ExpListDto expListDto){

        return expListService.updExpList(expListDto);
    }

    @PostMapping(value = "/添加")
    @ApiOperation(value =  "添加" , notes = "添加")
    @ApiImplicitParam(name = "ExpListDto", value = "快递价格修改对象", required = true, paramType = "query")
    public ResultUtil<Long> insert(@NotNull(message = "id不能为空") @Validated ExpListDto expListDto){
